...
<div class="row">
	...
	<sf:form action="${ctx}/admin/article/update" class="form-horizontal " modelAttribute="article" method="post">
	
        <sf:input path="articleId" style="display:none"/>
        <sf:input path="createDate" style="display:none"/>
        <sf:input path="thumb" style="display:none"/>
        <sf:input path="asn" style="display:none"/>
